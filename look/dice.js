...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-67a3d546');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-67a3d546');}
...
function clearFlash(){dieView.classList.remove('rl-win-67a3d546');dieView.classList.remove('rl-lose-67a3d546');if(frameEl){frameEl.classList.remove('rl-win-67a3d546');frameEl.classList.remove('rl-lose-67a3d546');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-67a3d546');if(frameEl){frameEl.classList.add('rl-win-67a3d546');}}else{dieView.classList.add('rl-lose-67a3d546');if(frameEl){frameEl.classList.add('rl-lose-67a3d546');}}
...
var brandEl=document.querySelector('.rl-brand-67a3d546');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
